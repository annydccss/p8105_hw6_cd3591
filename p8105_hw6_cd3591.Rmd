...
Across repeated 80/20 cross-validation splits, the proposed model had the smallest mean RMSE (280.48), which indicates the best out-of-sample predictive performance among the three models. Model 2, which includes head circumference, length, sex, and all interactions, had a slightly larger mean RMSE (288.48). Model 1, using only birth length and gestational age, performed worst with the largest mean RMSE (332.49).